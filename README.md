...
✔ **Maintain detailed, organized, and accurate laboratory records.** You will maintain an electronic lab notebook. Your notes should allow your work to be reproduced (meaning they must be understandable by people other than yourself) and will help to assign credit for authorship. They are required by funding agencies and for any potential patents. Be aware that your notes, records and all tangible research data, including sequences and analyses, are property of the lab. When you leave the lab, I encourage you to take copies of your data with you, but one full set of all data must stay in the lab, with appropriate and accessible documentation.  Regularly backup your computer data. For more detailed guidelines, see the XXX section below.
...
The Lowe-Power lab is a collaborative team of sciences to work together to advance knowledge and understanding of our natural world.  We are committed to creating a welcoming and respectful place for learning, teaching, and contributing.  We value ideas, open minds, hard work, and fun. All members and guests of our lab are expected to demonstrate respect and courtesy to others.  We treat physical and emotional safety seriously. 

The Lowe-Power lab is a positive and professional environment where we use welcoming and inclusive language, are respectful of different viewpoints and experiences, do our best to gracefully accept and provide professional constructive criticism, and focus on what is best for our lab community.  Science can be stressful and difficult. Although you weill experience frustrating and emotionally challenging days in the lab, continued courtesy and respect towards others is expected.  If you falter, sincerely ask for forgiveness from your labmates. 
...
## 4.2. @ucdavis.edu Google Chrome Profiles
...
1. Explore the shared resources in the shared folder. I encourage people to Sync the folders that start with "1-" (e.g. Images, professional development resources, etc.) and Sync relevant folders that start with "2-" (e.g. manuscripts they are co-authoring or lab management files like biosafety permits, etc). 
    * When you add useful content to the lab Box folder, consider advertising it on the lab slack. 

### 4.4.1. Good things about Box:
...
1. **LowePowerLab Events** calendar: keep track of lab events like lab meetings, journal clubs, retreats, and lab members' birthdays.  *This calendar posts weekly and daily to #announcements on Slack.*
...
* **Research Updates** (<1 hr 20 min). The presenting member will present their research goals, progress, and problems to foster a discussion where ideas and perspectives are exchanged. As a general rule, we will avoid powerpoint.  Powerpoint presentations feel like a final product and in lab meetings they often set a tone of passive listening (we want critical thinking) or combativeness (your data is wrong!). I want us to collegially critique the data, experiments, hypotheses in order to make the final data strong and robust. 
    * **Standard Lab Report Format**: Word document with embedded figures + figure legend that describes the experiment.  If it's a non-standard experimental approach, use a cartoon to show the methods (ProTip: [BioRender](Biorender.com)).  These don't have to be flawless, but they should be good enough to communicate. 
...
* **Format**: You will verbally present this paper to me in a < 30 min meeting (no slides, but written notes + printed papers will keep you on track). [Questions to ask yourself when Critically Reading Papers](https://docs.google.com/document/d/1pINurXGzFupcheqGCibuYJ5FHhhTupOlrRmX4vHb4OI/edit?usp=sharing)

**Career Planning meetings**: In January and July, Tiffany will hold career planning meetings with post-docs, graduate students, junior specialists, and lab managers. We will follow [these guidelines](files/career_meeting_guidelines.pdf). 

## 5.4. Organization

One way of maintaining sanity in academic work is to be as organized as possible.  This is essential because disorganization doesn't just hurt you, it hurts your collaborators, people whose help you need, and people who later work to build off of your scientific contributions. 

### 5.4.1. Deadlines and your PI
...
If you want feedback on research proposals/statements, teaching statements, or other work that requires multiple back-and-forth interactions between you and Tiffany before a hard deadline, give her as much time as you can; at the very least three weeks. 
...
**Giving Support**. Even if you aren't friends with a labmate, it is in your best interest to have a kind professional relationship with them.  If you help each other, the altuism will benefit you.
...
**Reference Management Software**. They are all flawed, but nonetheless superior to manually curating citations in your papers, grants, theses, etc. This software both serves as a paper database (local, but you )
...
* Making [Plasmid Maps]()(XXXRemember to add this page!) for published vectors available through read-only links to the Benchling files. 
...
# 7. Carbon Footprint of our research

Wetlab research inevitably uses a lot of single-use plastics.  It is impossible to avoid this, but there are ways that we can reduce our waste without compromising integrity of our data or affecting chemical/biological/environmental safety. 

Tiffany and the lab will write recommendations on the [Reducing the Carbon Footprint](https://github.com/lowepowerlab/protocols/blob/master/carbon_footprint.md). 

# 8. Funding
Funding for the lab currently comes fom Tiffany's start-up package from UC Davis. 

Use judgement when using lab resources, including your own time.  Be careful to order the correct items.  For standard consumables that we have a quote-price for, do not ask Tiffany for permission. If there are small tools < $50 that will improve your work, purchase them. For more expensive items, propose the purchase on the #ordering Slack channel (provide brief rationale). For large purchases, we can get the best price by getting competitive quotes from several vendors. Tiffany will lead these quotes at the beginning, but will eventually delegate it as a lab chore. We will try to have guidelines for purchasing on the [purchasing protocol](https://github.com/lowepowerlab/protocols/blob/master/purchasing.md)
...
# 9. Computing & Software recommendations
...
**Graphpad Prism**. Full time staff should ask me (Tiffany) or the lab manager how to get an annual license.  We use this software for graphing & basic statistics. Access to their [statistics guide](https://www.graphpad.com/guides/prism/8/statistics/index.htm) is free for everyone. We'll try to install Graphpad onto a shared computer for use by undergraduates. 
...
**Affinity Designer**. Vector-based graphics software.  Way cheaper than Adobe Illustrator/Photoshop ($50 license). Lab will pay for licenses for lab issued computers. (I think we contact Phoenix IT to purchase licenses of this?)
